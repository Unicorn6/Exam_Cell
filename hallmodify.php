...
font-size: 16px;">&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 ">
                     <h2 class="und">Exam Hall Modify Entry</h2>
                     <hr>
                        <br><br>

                        <form class="form-horizontal box" action="hallmodify.php" method="post">
             ...
             <br>
						...
						switch($dep)
						{
							case "CS"||"ME":$dis=3;break;
							case "EC"||"EE":$dis=2;break;
							case "CE"||"AR":$dis=1;break;
						}
                        if($t=$db->query("UPDATE ehall SET row=$row,col=$col,avail=$avail,draw=$draw,distance=$dis WHERE rno='$rno'"))
                        {
