...
function classcap(&$classno,$total,$dd,$db){
                                ...
                                if ($result = $db->query("SELECT * FROM ehall WHERE `$dd`=1 order by row desc"))
                                 {
                                      $i=0;
...
//Students detail updated------------	
	/*?><script><?php echo("location.href =staff.php?date1=$d1&date2=$d2&title=$title");?></script><?php*/
//header("location:staff.php?date1=$d1&date2=$d2&title=$title");
$link="staff.php?date1=$d1&date2=$d2&title=$title";
	
?>
	<a href="<?php echo $link?>">Staff Allocation</a>