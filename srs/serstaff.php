...
font-size: 16px;"> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
                 ...
                 <!-- /. ROW  -->
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="post" action="seriesstaffinsertion.php">
                                ...
                                <div class="tab-pane fade active in" id="cs">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
										<div class="panel-heading">Default Selector     </div>
                                         ...
                                         <?php
									if($res=$db->query("SELECT id,name FROM teacher WHERE dept like '$dept'"))
									{
      ...
      <span class=\"input-group-addon\">
        <input type=\"checkbox\" id=".$ary['id']." onClick=\"Select(this.id)\"/>
      </span>
										<div class=\"form-control\">".$ary['name']."</div>
    </div></td>
