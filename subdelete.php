...
font-size: 16px;">&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 ">
                     <h2 class="und">Student Data Entry Delete</h2>
                     <hr>
                        <br><br>


       <form class="form-horizontal  box" action="stu.php" method="post">
          <div class="form-group">
            <label class="control-label col-sm-2" for="fid">Subject Id:</label>
               <div class="col-sm-10">
                 <input type="text" class="form-control" name="fid" placeholder="Enter Subject id To Delete">
                 <br>
               </div>
       ...
       // Create connection
       $fid=$_POST["fid"];
           if ($t=$conn->query("DELETE FROM subject WHERE subid='$fid'")) {
