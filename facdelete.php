...
font-size: 16px;">&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 ">
                     <h2 class="und">Faculty Data Entry Delete</h2>
                     <hr>
                        <br><br>


       <form class="form-horizontal  box" action="facdelete.php" method="post">
          <div class="form-group">
            <label class="control-label col-sm-2" for="fid">Faculty Id:</label>
               <div class="col-sm-10">
                 <input type="text" class="form-control" name="fid" placeholder="Enter Faculty Id To Delete">
                 <br>
               </div>
	...
	require('database.php');
     ...
     // Create connection
     $fid=$_POST["fid"];
         if ($t=$db->query("DELETE FROM teacher WHERE id='$fid'")) {
