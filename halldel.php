...
font-size: 16px;">&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 ">
                     <h2 class="und">Exam Hall Data Entry Delete</h2>
                     <hr>
                        <br><br>


       <form class="form-horizontal  box "action="halldel.php" method="post">
          <div class="form-group">
            <label class="control-label col-sm-2" for="fid">ExamHall Id:</label>
               <div class="col-sm-10">
                 <input type="text" class="form-control" name="fid" placeholder="Enter Examhall Id To Delete">
                 <br>
               </div>
       ...
       <div style="padding-left: 46%;">
          <input type="submit" name="sub" class="btn  pmd-btn-raised pmd-ripple-effect btn-info .btn-block."></input>
           </div>
       </div>
       </form>
       <?php
       ...
       // Create connection
       $fid=$_POST["fid"];
           if ($t=$db->query("DELETE FROM ehall WHERE rno='$fid'")) {
