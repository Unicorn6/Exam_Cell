...
font-size: 16px;">&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Exam Hall Viewer</h2>   
                        <h5>Details of Exam hall</h5>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Column</th>
                                            <th>Available</th>
                                            <th>Distance/Priority</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                       <?php
                                        require('database.php');
										$out=$db->query("select * from ehall");
                                       ...
                                       echo " <tr class=\"odd gradeX\">
                                            ...
                                            <td>".$res['row']."</td>
                                            <td>".$res['col']."</td>
                                            <td class=\"center\">".$res['avail']."</td>
                                            <td class=\"center\">".$res['distance']."</td>
                                        </tr>";
										}
										?>
                                    </tbody>
