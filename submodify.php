...
font-size: 16px;">&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 ">
                     <h2 class="und">Subject Info Modify</h2>
                     <hr>
                        <br><br>

                        <form class="form-horizontal box" action="submodify.php" method="post">
                           <div class="form-group">
                             <label class="control-label col-sm-2" for="Adno">Sub Id:</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="adn" placeholder="Enter Sub Id">
                                  <br>
                                </div>
             ...
             <br>
							 ...
							 <label  class="control-label col-sm-2" for="slot">Slot:</label>
                                    <div class="col-sm-10">
                              <select class="form-control" name="slot" type="text">
                        ...
                        $dept=$_POST['dept'];
                        $aval=$_POST['optradio'];
                            if ($t=$db->query("UPDATE subject SET drawhall='$aval',sname='$name',sem=$sem,slot='$slot',dept='$dept' WHERE adno='$adn'")) {
