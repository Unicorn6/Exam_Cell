...
<head>
    ...
    <title>Faculty Modification</title>
	<!-- BOOTSTRAP STYLES-->
...
font-size: 16px;">&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 ">
                     <h2 class="und">Faculty Info Modify</h2>
                     <hr>
                        <br><br>


       <form class="form-horizontal  box" action="facmodify.php" method="post">
       ...
       if ($t=$db->query("UPDATE teacher SET email='$email',phno=$mob,name='$name',dept='$dept',desig='$desc',pp='$pri',pu='$pri' WHERE id='$fid'")) {
